...
object BigDataProcessing {
  ...
  /** Load graph data from file (generated by the program) */
  ...
  def convertToBFS(line: String, startCity: String): BFSNode = {
    ...
    // Extract subsequent city names into the connections array
  ...
  /** Combine BFS Nodes for the same city, preserving the shortest distance and newer state. */
  ...
  def main(args: Array[String]): Unit = {
    ...
    // (Looks for this guy and let me know if you found him)
    ...
    print(s"Loading cities list from $citiesPath...")
    ...
    print("Writing edge data to current working directory...")
    ...
    // Writing graph data
    print("Writing graph data to current working directory...")
    ...
    if (hitCounter.value == 0) {
      println("Cannot find the target city.")
    }
    println("------------------------------------------------")
    println("FINISH!")
  }
